...
public class TestController {
    ...
    @Autowired
    @Qualifier("ds2")
    private DruidDataSource druidDataSource2;
    ...
    public void setJdbcTemplate(JdbcTemplate jdbcTemplate) {
        ...
        jdbcTemplate.setDataSource(druidDataSource1);//设置dataSource
    ...
    public String get2(){
        //观察控制台的打印信息.
        System.out.println(druidDataSource2.getUrl());
        return"ok.2";
    }
    ...
    public String get3(){
        //观察控制台的打印信息.
        JdbcTemplate jdbcTemplate =new JdbcTemplate(druidDataSource1);
